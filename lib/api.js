...
export async function getItemMedia(itemId, locale = "en_GB") {
  const url = `https://eu.api.blizzard.com/data/wow/media/item/${itemId}?namespace=static-eu&locale=${locale}`;
  return fetchFromAPI(url);
}
